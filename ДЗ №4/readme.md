...
### По результатам работы программы видим, что максимальное значение аргумента, при котором результат вычисления факториала размещается в 32-х разрядном машинном слове - это 12, факториал которого равняется 479_001_600. Факториал же 13 будет 6_227_020_800, что чуть ли не в 3 раза больше максимально допустимого числа: 2_147_483_647.
