...
### Псевдо-команда *la* работает через команду *auipc* и имеет U-тип (непосредственное значение-регистр).

### Псевдо-команда *li* работает через команду *addi* и имеет I-тип (непосредственное значение-регистр-регистр).

### Видео с кодом программы и моими комментариями: https://youtu.be/1N-PdQVpGsA
