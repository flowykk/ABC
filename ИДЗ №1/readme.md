...
- В отчёте ниже приведены [log](https://github.com/flowykk/ABC/blob/main/%D0%98%D0%94%D0%97%20%E2%84%961/readme.md#%D1%84%D0%B0%D0%B9%D0%BB-idz1asm), результаты работы [Тестовой программы] и [Скриншоты] (## Рассмотрим на скриншотах различные ситуации входных данных, чтобы показать работу программы.
