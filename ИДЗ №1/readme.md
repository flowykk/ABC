...
- В отчёте ниже приведены [Текст ссылки](#лог-программы), результаты работы [Тестовой программы] и [Скриншоты] (## Рассмотрим на скриншотах различные ситуации входных данных, чтобы показать работу программы.
).
## Код программы
