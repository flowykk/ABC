...
- В отчёте ниже приведены [Лог программы из консоли](##Лог программы.
), результаты работы [Тестовой программы] и [Скрин шоты](## Рассмотрим на скриншотах различные ситуации входных данных, чтобы показать работу программы.
).
## Код программы
