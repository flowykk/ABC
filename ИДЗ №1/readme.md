...
- В отчёте ниже приведены [log](https://github.com/flowykk/ABC/tree/main/%D0%98%D0%94%D0%97%20%E2%84%961#%D0%BA%D0%BE%D0%B4-%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D1%8B), результаты работы [Тестовой программы] и [Скриншоты] (## Рассмотрим на скриншотах различные ситуации входных данных, чтобы показать работу программы.
